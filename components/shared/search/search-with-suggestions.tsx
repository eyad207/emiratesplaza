    ...
    <div className={`relative w-full max-w-2xl ${className}`}>
      ...
      <div className='relative'>
        ...
        <Input
          ...
          className='pl-10 pr-12 py-3 text-lg border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-0 transition-colors'
          onKeyDown={(e) => {
      ...
      {spellCheck && spellCheck.isLikelyMisspelled && (
